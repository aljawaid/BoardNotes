...
<div id="tabs">
  <ul>
    ...
    print '/kanboard/?controller=BoardnotesController&action=BoardnotesShowProjectRefresh&plugin=boardnotes&project_id=9998';
    print '">';
    print 'General';
    print '</a></li>';
    ...
    print '/kanboard/?controller=BoardnotesController&action=BoardnotesShowProjectRefresh&plugin=boardnotes&project_id=9997';
    print '">';
    print 'Todo';
    print '</a></li>';
